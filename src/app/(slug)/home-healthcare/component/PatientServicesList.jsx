...
const PatientServicesList = ({ onClose, homeHealthcareService, serviceName }) => {
  ...
  // Unified Theme (Same as 24/7 component)
  const unified = {
      ...
      <div className="min-h-screen py-6 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-gray-50 rounded-b-xl shadow-lg p-6">
              ...
              <div className="mb-6 grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <Card className="border border-gray-200 hover:shadow-lg transition-all">
                  <CardContent className="p-4 text-center">
                    ...
                    <h4 className="font-bold text-gray-900 text-2xl mb-1">
                      {statistics.totalServiceTypes || groupedServices.length}
                    </h4>
                ...
                <Card className="border border-gray-200 hover:shadow-lg transition-all">
                  <CardContent className="p-4 text-center">
                    <div className="w-12 h-12 bg-[#EEF3FF] rounded-full flex items-center justify-center mx-auto mb-2">
                      <ThumbsUp className="w-6 h-6 text-[#1E3B90]" />
                    </div>
                    <h4 className="font-bold text-gray-900 text-2xl mb-1">
                ...
                <Card className="border border-gray-200 hover:shadow-lg transition-all">
                  <CardContent className="p-4 text-center">
                    ...
                    <h4 className="font-bold text-gray-900 text-2xl mb-1">
                      {statistics.totalProviders || patientServices.length}
                    </h4>
            ...
            <div className="mb-6 grid grid-cols-1 md:grid-cols-4 gap-4">
              {[
                { icon: <Home className="w-6 h-6" />, title: "Home Care", desc: "Comfort of your home" },
                { icon: <UserCheck className="w-6 h-6" />, title: "Verified Staff", desc: "Qualified professionals" },
                { icon: <Shield className="w-6 h-6" />, title: "Safe & Secure", desc: "Your safety matters" },
                { icon: <Sparkles className="w-6 h-6" />, title: "Quality Care", desc: "Best-in-class service" },
              ].map((feature, idx) => (
                    ...
                    >
                      ...
                      <CardContent className="p-5 bg-white rounded-b-xl">
                        ...
                        <div className="space-y-2 mb-4">
                          {["Home Visit Available", "Qualified Professionals"].map((f, i) => (
                ...
                <Card className="border border-gray-200 bg-gradient-to-r from-[#EEF3FF] to-[#E1E8FF]">
                  <CardContent className="p-6">
                    <h3 className="text-xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                      <Target className="w-6 h-6 text-[#1E3B90]" />
                      Why Patients Choose Our Healthcare Services
                    </h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                      {[
                        { icon: <UserCheck className="w-5 h-5" />, title: "Patient-Centered", desc: "Care tailored to your needs" },
                        { icon: <Shield className="w-5 h-5" />, title: "Verified Providers", desc: "Only qualified professionals" },
                        { icon: <ThumbsUp className="w-5 h-5" />, title: "High Satisfaction", desc: "Highly rated by patients" },
                        { icon: <Heart className="w-5 h-5" />, title: "Compassionate Care", desc: "Treated with dignity & respect" },
                      ].map((benefit, idx) => (
                        <div
                          key={idx}
